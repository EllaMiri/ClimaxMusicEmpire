  ...
  const lastTitle = {
    ...
    return (
        <Box sx={style}>
           ...
           <Box sx={textContent}>
            <Box sx={titleBox}>
                <Typography sx={title} variant="h1" component="h1">CLIMAX MUSIC</Typography>
                <Typography sx={[title, lastTitle]} variant="h2" component="h2" style={{ color: "#E2B945"}}>EMPIRE</Typography>
            </Box>
                <Typography variant="p" component="p">Swedens aspiring music label</Typography>
                <Button style={{marginTop: '1rem'}} variant="contained" color="primary">Contact us</Button>
           </Box>
