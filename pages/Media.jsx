  ...
  return (
    ...
    <Box style={{paddingTop: '6rem'}}>
      <Box style={{display: 'flex'}}> 
          ...
          <Box style={{display: 'flex', marginBottom: '1rem', marginLeft: '3rem'}}>
        ...
        <Box style={{ display: 'flex', justifyContent: 'center'}}>
          <Box style={{width: '50%'}}>
          <Typography style={{marginLeft: "3rem"}} variant='p' component='p'>Lorem ipsum dolor sit amet,
        ...
        <img className={styles.image} src='/galleryImage.png' alt="artist image" />
        </Box>
      </Box>
    ...
    {isMobile &&
       <Box style={{paddingTop: '6rem',}}>
        <Box style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}> 
          ...
          <Image layout="intrinsic" src='/galleryImage.png' alt="artist image" height={450} width={350} />
        </Box>
        </Box>
        <Box style={{ display: 'flex', justifyContent: 'center'}}>
          <Box style={{width: '90%', marginTop: '1rem'}}>
          <Typography style={{textAlign: 'center'}} variant='p' component='p'>Lorem ipsum dolor sit amet,
            consectetur adipiscing elit, sed do eiusmod tempor
            incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
            nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
